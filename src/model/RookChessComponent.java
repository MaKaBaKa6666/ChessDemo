...
public class RookChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (ROOK_WHITE == null) {
            ROOK_WHITE = ImageIO.read(new File("./images/" + Main.getChessForm() + "/rook-white.png"));
        }

        if (ROOK_BLACK == null) {
            ROOK_BLACK = ImageIO.read(new File("./images/" + Main.getChessForm() + "/rook-black.png"));
        }
    }
    ...
    //判断合法的落子点，但是还不知道怎么写
//    public void pointCanMoveTo() {
//        ChessComponent[][] chessComponents;
//        for (int i = 0; i < 7; i++) {
//            for (int j = 0; j < 7; j++) {
//                ChessboardPoint destination = new ChessboardPoint(i, j);
//                if (canMoveTo(ClickController.getChessboard().getChessComponents(), destination)) {
//                    x.add(i);
//                    y.add(j);
//                }
//            }
